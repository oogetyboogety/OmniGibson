...
def main():
    ...
    if args.robot > 0:
        ...
        for i in range(args.robot):
            cfg["robots"].append({
                ...
                "position": [-1.3 + 0.75 * i + SCENE_OFFSET[args.scene][0], 0.5 + SCENE_OFFSET[args.scene][0], 0],
    ...
    cfg["objects"] = [{
        ...
        "model": "rjgmmy",
        "scale": 0.75,
        "position": [0.5 + SCENE_OFFSET[args.scene][0], -1 + SCENE_OFFSET[args.scene][0], 0.5],
        "orientation": [0., 0., 0.7071, -0.7071]
    }]
    ...
    cfg["objects"].extend([{
        ...
        "model": "agveuv",
        "scale": 1.5,
        "position": [0.5 + SCENE_OFFSET[args.scene][0], -1 + SCENE_OFFSET[args.scene][0], 0.8],
    ...
    },
    {
        ...
        "model": "lrdmpf",
        "scale": 2.5,
        "position": [0.5 + SCENE_OFFSET[args.scene][0], -1 + SCENE_OFFSET[args.scene][0], 1.2],
